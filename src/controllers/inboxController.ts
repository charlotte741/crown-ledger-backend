...
export class InboxController {
   ...
   */
  async getMessageAttachmentUrl(req: Request, res: Response): Promise<void> {
    try {
      ...
      const attachment = await emailService.getReceivedAttachment(message.resendEmailId, attachmentId);

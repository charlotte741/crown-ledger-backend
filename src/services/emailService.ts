...
class EmailService {
  ...
  generateAdminSavingsBalanceUpdateEmailHtml(
    fullName: string,
  ...
  generateAdminInvestmentBalanceUpdateEmailHtml(
    fullName: string,
    amountChanged: number,
    balanceBefore: number,
    balanceAfter: number,
  ...
  generateSupportTicketStatusUpdateEmailHtml(fullName: string, subject: string, ticketId: string, newStatus: string): string {
    ...
    generateAdminWalletCreditEmailHtml(
    fullName: string,
    amountChanged: number,
    balanceBefore: number,
    balanceAfter: number,
  ...
  generateWithdrawalRequestAdminEmailHtml(
    userFullName: string,
    accountNumber: string,
    amount: number,
  ...
  generateWithdrawalReviewedEmailHtml(
    fullName: string,
    amount: number,
    bitcoinAddress: string,
